...
class BaseModel
{
    ...
    {
        return DB::table($this->table)->where($where)->select(...$fields);
    }
     ...
     * @param array $where
     * @param array $fields
     * @return \Illuminate\Database\Eloquent\Model|\Illuminate\Database\Query\Builder|object|null|array
     */
    ...
    {
        return ArraySupport::stdClassToArray(DB::table($this->table)->where($where)->value($field));
    }
    ...
    {
        return DB::table($this->table)->where($where)->select('count(*)')->count();
    }
    ...
    {
        return DB::table($this->table)->where($where)->increment($column, $step);
    }
    ...
    {
        return DB::table($this->table)->where($where)->decrement($column, $step);
    }
    ...
    public function baseCreateDictionary($idArr = [], $idColumnName = 'id', $arrKey = 'id', $fields = ['*'], $extraWhere = [])
    {
        ...
        LogSupport::info(json_encode([$data, $this->table]));
        if ($data) {
